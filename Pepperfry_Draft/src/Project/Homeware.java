 ...
 * @author MAYUR_DEBU
 */
public class Homeware extends javax.swing.JFrame {

    /**
     * Creates new form Homeware
     */
    public Homeware() {
        setUndecorated(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Homeware.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
